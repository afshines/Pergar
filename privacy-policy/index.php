...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-card">
            ...
            <a href="https://khabaronline.app/" class="w3-bar-item w3-button w3-padding-large">HOME</a>

            <a href="https://khabaronline.app/privacy-policy/" class="w3-bar-item w3-button w3-padding-large">Privacy
                Policy</a>

            <a href="https://khabaronline.app/contact-us/" class="w3-bar-item w3-button w3-padding-large">Contact Us</a>
    ...
    <div class="w3-content" style="max-width:2000px;margin-top:46px">
        ...
        <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
            <h2 class="w3-wide">Application Privacy Policy</h2>
            <p class="w3-opacity"><i>"Khabaronline" is a free service and no fees are charged for using it.</i></p>
            <p class="w3-justify"> <strong>Data collection</strong><br>
                No specific information is received from the user.
            </p>
            <p class="w3-justify"> <strong>Log Data</strong><br>
            ...
            <p class="w3-justify">
                ...
                <strong>privacypolicy@khabaronline.app </strong> </p>
    ...
    <footer class="w3-container w3-padding-64 w3-center w3-opacity w3-light-grey w3-xlarge">
        ...
        <p class="w3-medium">Powered by KhabarApp</a>
        </p>
    </footer>
